...
fish_per_hour=[table2array(salmon_data_2012(:,5:6)),table2array(salmon_data_2012(:,9:10))]';
...
resparams.train_length = size(fish_per_hour,2)-5; % number of time points used to train - I am changing to size(fish, 1) - 50
...
p(1,:)=J(1,2,:);%chinook 0 hatchery  to chinook0 wild
p(2,:)=J(2,2,:);%chinook 0 wild to chinook0 wild
p(3,:)=J(3,2,:);%chinook1 hatchery to chinook0 wild
p(4,:)=J(4,2,:);%chinook1 wild to chinook0 wild
...
sgtitle('Time-dependent interaction strengths - Chinook0 Wild')
