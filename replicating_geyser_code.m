...
%1 month=43200 min;
delays=[1,2,3,4,5,6];%daily sampling - 6 day delay
dl_labels=["1 day", "2 day", "3 day", "4 day", "5 day", "6 day"];
delays=floor(delays);
% rng shuffle
...
x(:,12)=table2array(T(1:147,14));
x(:,13)=table2array(T(1:147,15));
x(:,14)=table2array(T(1:147,18));
x(:,15)=table2array(T(1:147,20));

x=x';

names=["chinook0 hatchery"; "chinook0 wild"; "chinook1 hatchery"; "chinook1 wild"; "coho hatchery"; "coho wild"; "steel hatchery"; "steel wild"; "pink wild"; "pink wild"; "chum wild"; "flow"; "temp"; "atu solstice"; "photoperiod"]';
compare = zeros(1,6,15,15);
for imonth=1:1
for idel=1:6
   disp([imonth,idel])
